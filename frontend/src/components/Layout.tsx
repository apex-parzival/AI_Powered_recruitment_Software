        ...
        <div style={{ display: 'flex', minHeight: '100vh' }}>
            ...
            <aside style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, paddingLeft: 4, marginBottom: 32 }}>
                    <div style={{ width: 38, height: 38, background: 'linear-gradient(135deg, #7C3AED, #9B3AED)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 4px 12px rgba(124,58,237,0.4)' }}>
